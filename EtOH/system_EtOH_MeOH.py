...
def create_ccu_system(ins, outs, water_electrolyzer=None, hydrogen_green=None, hydrogen_blue=None, hydrogen_gray=None):
    ...
    ks = [bst.units.IsentropicCompressor(P=3*101325), 
          bst.units.IsentropicCompressor(P=8.8*101325),
    ...
    # C1101 = units.MultistageCompressor('C1101', ins=S1301-0, outs='', compressors=ks, hxs=hxs) # won't work (no ins connection)
    C1101 = units.MultistageCompressor('C1101', ins=S1301-0, outs='', n_stages=3, pr=2.9)
